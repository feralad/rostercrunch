...
![](pic_Adam_Headshot.jpg){fig-align="left" width="377"}
...
I'd be happy to connect with you on [LinkedIn](https://www.linkedin.com/in/adamferalio/){target="_blank"}, [GitHub](https://github.com/feralad){target="_blank"}, and/or [Twitter/X](https://twitter.com/RosterCrunch){target="_blank"} (specific to my baseball fandom). I'm still not exactly sure how to use those platforms, but I'm there. I set up an email as well: [rostercrunch@gmail.com](mailto:rostercrunch@gmail.com). 
