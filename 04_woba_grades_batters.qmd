...
all_batter_career_data_by_ID %>% 
  ...
  labs(
    title = "Batter wOBA Difference First & Post 150 PAs", 
    x = "wOBA Difference", 
    y = "Density", 
    caption = "Minimum Career Plate Appearances = 600") + 
  guides(
    fill = 
      guide_legend(
...
all_batter_career_data_by_ID %>% 
  ...
  scale_x_continuous(limits = c(-.15, .15)) +
  labs(
    title = "Batter wOBA Difference First & Post 600 PAs", 
    x = "wOBA Difference", 
    y = "Density", 
    caption = "Minimum Career Plate Appearances = 1,800") + 
  guides(
    fill = 
      guide_legend(
        title = "Top 100 Prospect",
