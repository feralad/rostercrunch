...
While this project is descriptive analysis and not predictive, I like what [Ariel Cohen](https://twitter.com/ATCNY){target="_blank"}, an expert fantasy baseball player/analyst and actuary by day, I believe, [writes](https://www.rotoballer.com/2023-fantasy-takeaways/1258560?utm_source=dlvr.it&utm_medium=twitter){target="_blank"}...
...
#| tbl-subcap: ["**Batting Prospects**", "**Pitching Prospects**"]
#| layout-ncol: 2
...
batting_prospect_mlb_debut_rate %>% 
  kable(col.names = c("Prospect Rank", "Yes", "No", "Total"), 
        align = "llll", 
        caption = "**Batting Prospects Who Made MLB Debut**")

## Pitching Prospects
pitching_prospect_mlb_debut_rate %>% 
  kable(col.names = c("Prospect Rank", "Yes", "No", "Total"), 
        align = "llll", 
        caption = "**Pitching Prospects Who Made MLB Debut**")
```
